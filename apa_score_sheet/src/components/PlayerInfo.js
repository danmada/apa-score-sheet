    ...
    return (
        ...
        <div>
            <form>
                ...
                <input type="text" placeholder="Player 1 Name" value={playerOne} onChange={(e) => setPlayerOne(e.target.value)}/>
                <label>Skill Level:</label>
                    <select id="skilllevel" name="skilllevel" onChange={(e) => setPlayerOneSkill(e.target.value)}>
